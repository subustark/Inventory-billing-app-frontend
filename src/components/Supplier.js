        ...
        <div className="container-fluid py-4">
                    ...
                    <div className="card my-4">
                        <div className="card-header p-0 position-relative mt-n4 mx-3 z-index-2">
                            <div className="bg-gradient-warning shadow-primary border-radius-lg p-2 d-flex justify-content-between align-items-center">
                                <h5 className="text-white text-uppercase ps-3 pt-2">Suppliers Zone</h5>
                                {isAdmin && 
                                <button onClick={() => setAddModal(true)} className="text-white text-md me-5 p-2 text-capitalize font-weight-bold btn-outline-white bg-gradient-success"><i className="fa-solid fa-plus"></i>&nbsp;&nbsp;Add Supplier</button>}
                            </div>
                        </div>
                        <div className="card-body px-0 pb-2">
                            <div className="table-responsive p-0">
                                <table className="table align-items-center mb-0">
                                    <thead>
                                        <tr>
                                            <th className="text-uppercase text-primary text-md font-weight-bold">Name of Supplier</th>
                                            <th className="text-uppercase text-primary text-md font-weight-bolder ps-2">Mobile</th>
            ...
            <Modal
                ...
                <form onSubmit={updateSupplier}>
                    <div className="mb-1">
                        <label style={{color:"blue",fontSize:"15px"}}>Supplier name</label>
                    ...
                    <div className="mb-1">
                        <label style={{color:"blue",fontSize:"15px"}}>Last order</label>
                    ...
                    <div className="mb-1">
                        <label style={{color:"blue",fontSize:"15px"}}>Profile Image</label>
