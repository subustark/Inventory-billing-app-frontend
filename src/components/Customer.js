        ...
        <div className="container-fluid py-4">
                    ...
                    <div className="card my-4">
                        <div className="card-header p-0 position-relative mt-n4 mx-3 z-index-2">
                            <div className="bg-gradient-warning shadow-primary border-radius-lg p-2 d-flex justify-content-between">
                                <h5 className="text-white text-capitalize ps-3 pt-2">Customers table</h5>
                                {isAdmin &&
                                    <button onClick={() => setAddModal(true)} className="text-white text-md me-5 p-2 text-capitalize font-weight-bold btn-outline-white bg-gradient-success"><i className="fa-solid fa-plus"></i>&nbsp;&nbsp;Add Customer</button>}
                            </div>
                        </div>
                        <div className="card-body px-0 pb-2">
                            <div className="table-responsive p-0">
                                <table className="table align-items-center mb-0">
                                    <thead>
                                        <tr>
                                            <th className="text-center text-uppercase text-primary text-md font-weight-bolder">Name of Customer</th>
                                            <th className="text-center text-uppercase text-primary text-md font-weight-bolder">Mobile</th>
                                            <th className="text-center text-uppercase text-primary text-md font-weight-bolder">Email Address</th>
                                            <th className="text-center text-uppercase text-primary text-md font-weight-bolder">Last Order</th>
                                            {isAdmin &&
                                                <th className="text-center text-uppercase text-primary text-md font-weight-bolder">Edit</th>}
                                        </tr>
                                    </thead>
                                    <tbody>
                                        {customers.map((cust) => {
            ...
            <Modal
                ...
                <form onSubmit={updateCustomer}>
                    <div className="mb-1">
                        <label style={{color:"blue",fontsize:"20px"}}>Name of Customer</label>
                    ...
                    <div className="mb-1">
                        <label style={{color:"blue",fontsize:"20px"}}>Last order</label>
                    ...
                    <div className="mb-1">
                        <label style={{color:"blue",fontsize:"20px"}}>Profile Image</label>
