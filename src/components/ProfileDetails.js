...
const ProfileDetails = () => {
    ...
    const updateAdminProfile = (id) => {      
        ...
        fetch(`https://inventory-billing-app-backend.vercel.app/admin/profile/${id}`, {
            method: "PUT",
    ...
    const getAdminDetails = () => {
        ...
        fetch("https://inventory-billing-app-backend.vercel.app/admin/profile", {
            method: "POST",
    ...
    return (
        <div className="container-fluid px-2 px-md-4">
            <div className="page-header min-height-100 border-radius-xl" style={{ backgroundImage: 'https://images.unsplash.com/photo-1531512073830-ba890ca4eba2?ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&ixlib=rb-1.2.1&auto=format&fit=crop&w=1920&q=80' }}>
            ...
            <div className="card card-body mx-3 mx-md-4 mt-n6">
                ...
                <div className="row">
                    <div className="row">
                        <div className="mb-3">
                            <label htmlFor="exampleFormControlInput1" className="form-label" style={{color:"blue",fontSize:"20px"}}>Email Address</label>
                            <input type="email" value={username}  className="form-control" id="exampleFormControlInput1" placeholder="name@example.com" readOnly />
                        </div>
                        <div className="mb-3">
                            <label htmlFor="exampleFormControlInput1" className="form-label" style={{color:"blue",fontSize:"20px"}}>City</label>
                        ...
                        <div className="mb-3">
                            <label htmlFor="exampleFormControlInput1" className="form-label" style={{color:"blue",fontSize:"20px"}}>Country</label>
                        ...
                        <div className="mb-3">
                            <label htmlFor="exampleFormControlInput1" className="form-label" style={{color:"blue",fontSize:"20px"}}>Date of Birth</label>
                        ...
                        <div className="mb-3">
                            <label htmlFor="exampleFormControlInput1" className="form-label" style={{color:"blue",fontSize:"20px"}}>Pincode</label>
                        ...
                        <div className="mb-3">
                            <label htmlFor="exampleFormControlInput1" className="form-label" style={{color:"blue",fontSize:"20px"}}>Gender</label>
                        ...
                        <div className="mb-3">
                            <label htmlFor="exampleFormControlTextarea1" className="form-label" style={{color:"blue",fontSize:"20px"}}>Description</label>
                        ...
                        <div className="d-flex justify-content-center">
                            <button onClick={()=>updateAdminProfile(id)} className="btn bg-gradient-success text-white text-capitalize w-25 opacity-8">
                                Update profile
                            </button>
                        </div>
                    </div>
