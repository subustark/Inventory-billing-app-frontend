...
const Product = () => { 
  ...
  const getProduct = (id) => {
    fetch(`https://inventory-billing-app-backend.vercel.app/products/${id}`, {
      ...
      .then((data) => data.json())
      .then((res) => { setProductName(res.name); setProductImage(res.image); setProductId(res._id);})
      .catch((e) => console.log(e));
  }
    ...
    <div className="container-fluid ps-3 pe-3">
      {isAdmin && 
       <div className='container-fluid d-flex justify-content-end'>
        <button onClick={() => setAddModal(true)} className='btn bg-gradient-success'><i className="fa-solid fa-plus"></i>&nbsp;&nbsp;Add Product</button>
      </div>}
     {products ? 
      <div>
      <div className="row g-4">
        {products.map((product) => {
          return (
            <div key={product._id} className="col-xl-3 col-sm-6 mb-xl-0 mb-4">
      ...
      <Modal
        ...
        <form onSubmit={updateProduct}>
          <div className="mb-3">
            <label style={{color:"blue",fontSize:"15px"}}>Product name</label>
          ...
          <div className="mb-1">
            <label style={{color:"blue",fontSize:"15px"}}>Product Image</label>
      ...
      <Modal
        ...
        <form onSubmit={addProduct}>
          ...
          <div className="mb-2">
            <label style={{color:"blue",fontSize:"15px"}}>Product Image</label>
            <input onChange={(e) => setNewProductImage(e.target.value)}
              type="text"
              className="form-control"
              placeholder="Enter product image"
            />
