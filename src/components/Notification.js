    ...
    return (
        <div className="container-fluid py-10">
            <div className='d-flex float-end me-5'>
                <button onClick={() => setAddModal(true)} className="text-white text-md me-5 p-2 text-capitalize font-weight-bold btn-outline-white bg-gradient-success opacity-10"><i className="fa-solid fa-plus"></i>&nbsp;&nbsp;Add Notification</button>
            </div>
            <div className="card m-5" style={{ width: "70rem" }}>
                ...
                <ul className="list-group list-group-flush">
                    {notifications.map((notification) => {
                        return (
                            <li className="list-group-item"><span className='font-weight-bolder text-md me-5'>{notification.customerName}</span>&nbsp;&nbsp;&nbsp;&nbsp; : &nbsp;&nbsp;{notification.message}</li>
                        )
                    })}
                </ul>
            </div>
            <Modal
                ...
                <form onSubmit={addNotification}>
                    ...
                    <div className="mb-1">
                        <label>Message</label>
                        <input onChange={(e) => setNewNotification(e.target.value)}
                            type="text"
                            className="form-control"
