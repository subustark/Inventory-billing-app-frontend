...
const Stock = () => {
  ...
  const updateStock = (e) => {
    ...
    fetch(`https://inventory-app-backend-i62a.onrender.com/stocks/${stockId}`, {
      method: "PUT",
  ...
  const removeStock = (id) => {
    fetch(`https://inventory-app-backend-i62a.onrender.com/stocks/${id}`, {
      method: "DELETE"
    })
      .then((data) => data.json())
  ...
  const getStock = (id) => {
    fetch(`https://inventory-app-backend-i62a.onrender.com/stocks/${id}`, {
      ...
      .then((data) => data.json())
      .then((res) => { setStockName(res.name); setPricePerKg(res.pricePerKg); setAvailability(res.availability); setStockId(res._id); setRequirement(res.requirement) })
      .catch((e) => console.log(e));
  }
  ...
  return (
    <div className="container-fluid ps-3 pe-3">
      ...
      <div className='container-fluid d-flex justify-content-end'>
        <button onClick={() => setAddModal(true)} className='btn bg-gradient-success'><i className="fa-solid fa-plus"></i>&nbsp;&nbsp;Add Stock</button>
      </div>}
      {stocks ? 
      <div>
                ...
                <div className="card">
                  <div className="card-header p-3 pt-2">
                    <div className="text-center pt-1">
                      ...
                      <h5 className="mb-0 pt-1">Price per kg : ₹ {stock.pricePerKg}</h5>
                    </div>
                  </div>
        ...
        <Modal
          ...
          <form onSubmit={updateStock}>
            <div className="mb-3">
              <label style={{color:"blue",fontSize:"15px"}}>Stock name</label>
            ...
            <div className="mb-1">
              <label style={{color:"blue",fontSize:"15px"}}>Stock price per kg</label>
              <input value={pricePerKg} onChange={(e) => setPricePerKg(e.target.value)}
                type="text"
                className="form-control"
            ...
            <div className="mb-1">
              <label style={{color:"blue",fontSize:"15px"}}>Availability</label>
            ...
            <div className="mb-1">
              <label style={{color:"blue",fontSize:"15px"}}>Requirement</label>
        ...
        <Modal
          ...
          <form onSubmit={addStock}>
            <div className="mb-2">
              <label style={{color:"blue",fontSize:"15px"}}>Stock name</label>
              <input onChange={(e) => setNewStockName(e.target.value)}
                type="text"
                className="form-control"
                placeholder="Enter stock name"
              />
            ...
            <div className="mb-2">
              <label style={{color:"blue",fontSize:"15px"}}>Price per kg/l</label>
              <input onChange={(e) => setNewStockPricePerKg(e.target.value)}
                type="text"
                className="form-control"
            ...
            <div className="mb-2">
              <label style={{color:"blue",fontSize:"15px"}}>Availability</label>
              <input onChange={(e) => setNewStockAvailability(e.target.value)}
                type="text"
                className="form-control"
                placeholder="Enter availability"
              />
            ...
            <div className="mb-2">
              <label style={{color:"blue",fontSize:"15px"}}>Requirement</label>
              <input onChange={(e) => setNewStockRequirement(e.target.value)}
                type="text"
                className="form-control"
                placeholder="Enter requirement"
              />
